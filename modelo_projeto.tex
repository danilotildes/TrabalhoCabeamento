...
\lfoot{\footnotesize \texttt{Cabeamento Danilo Grupo ML} \textbullet ~Modelo de projeto}
...
\title{Modelo para um projeto de cabeamento estruturado teste GRUPO ML}					% Title of your article goes here
